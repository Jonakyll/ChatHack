...
public class LogOutToServerReader implements Reader<Frame> {
	...
	public Frame get() {
		...
		if (logOutType == 0) {
			return new LogOutPublicFrame("you have been disconnected from the public server");
		}
		return new LogOutPrivateFrame("you have been disconnected from a private connection");
	}
